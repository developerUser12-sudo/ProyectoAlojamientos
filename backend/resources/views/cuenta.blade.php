                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        @if(session('nombreActualizado'))
                            <div id="nombreActualizado" class="alert alert-success"
                        ...
                        <form method="GET" action="{{ route('change-email') }}">
                            @csrf
                            <div class="mb-3">
                        ...
                        @if(session('correoCambiado'))
                            <div id="correoCambiado" class="alert alert-success"
                                style="position: relative; padding-right: 40px;">
                                {{ session('correoCambiado') }}
                                <button onclick="document.getElementById('correoCambiado').remove()"
                                    style="position:absolute;right:15px; background: none; border: none; font-weight: bold; font-size: 17px; cursor: pointer;">
                                    ×
                                </button>
                            </div>
