    ...
    <div class="container">
        ...
        <form action="{{ route('admin.createcoche') }}" method="POST">
            ...
            <div class="mb-3">
                ...
                <input type="number" id="total" name="total" class="form-control" required min="1">
            </div>

            <div class="mb-3">
                <label for="descuento" class="form-label">Descuento</label>
                <input type="number" id="descuento" name="descuento" class="form-control" required min="0">
            </div>
